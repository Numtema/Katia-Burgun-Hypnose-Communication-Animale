...
const diplomeKatia = "/assets/katia-burgun-formation-diplome.jpeg";
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative rounded-[3rem] overflow-hidden border border-site shadow-xl group h-full flex items-center justify-center bg-[var(--site-surface-solid)]">
              ...
              <img src={diplomeKatia} alt="Diplôme Hypnose Ericksonienne" className="w-full object-contain max-h-[800px] z-10 transition-transform duration-1000 group-hover:scale-[1.02]" />
            </div>
