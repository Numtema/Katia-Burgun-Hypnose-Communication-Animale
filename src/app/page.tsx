...
export default function Home() {
  ...
  const businessJsonLd = {
    ...
    "image": `https://katia-burgun.fr${portraitKatia2}`,
      ...
      <section id="home" className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden bg-site transition-colors duration-500">
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto mt-24 flex flex-col items-center">
          ...
          >
            ...
            <a href="#services" className="inline-flex items-center gap-2 rounded-full border border-[#8ba394]/20 px-8 py-3 text-[10px] uppercase tracking-widest font-bold text-site hover:bg-[var(--site-surface)] transition-all">Découvrir les services</a>
          </motion.div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-5">
            <div className="relative aspect-[4/5] rounded-[2.5rem] overflow-hidden border border-site group">
              <img src={portraitKatia2} alt="Portrait Katia Burgun" className="w-full h-full object-cover transition-all duration-1000 group-hover:scale-105" />
