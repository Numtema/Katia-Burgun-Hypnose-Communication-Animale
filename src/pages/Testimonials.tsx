...
export default function Testimonials() {
  const testimonials = [
    ...
    { t: "La formation en communication animale est fascinante. Katia transmet son savoir avec tellement de bienveillance et de clarté. Une vraie découverte intérieure.", n: "Élise M.", r: "Yvetot", c: "form", cat: "Formation", img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=200&h=200&fit=crop" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-20 max-w-7xl mx-auto pb-24">
          <AnimatePresence mode="popLayout">
            {filteredItems.map((item, i) => (
              ...
              >
                {/* Decorative Backing Rectangle (Canva offset style) */}
