      ...
      <section className="px-6 lg:px-16 py-12 relative overflow-hidden">
        <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative aspect-video rounded-[3rem] overflow-hidden border border-site shadow-2xl">
            <img src={hypnoseImg} alt="Séance d'hypnose apaisante" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="lg:order-1 relative">
            <div className="aspect-square rounded-[3rem] overflow-hidden border border-site">
               <img src="https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop&q=80&w=1200" alt="Méditation et calme intérieur" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
            </div>
      ...
      <section className="py-24 px-6 lg:px-16">
        <div className="mx-auto max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-[var(--site-surface)] border border-site rounded-[3rem] p-8 sm:p-12 relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <Link to="/tarifs" className="text-[10px] uppercase tracking-widest font-bold text-[#8ba394] hover:text-[#7a9283] transition-colors border-b border-[#8ba394]/20 pb-1">Toutes les mutuelles — voir la liste</Link>
          </div>
