    ...
    <div className="pt-32 min-h-screen bg-site transition-colors duration-500 pb-16">
      ...
      <section className="bg-[var(--site-surface)] py-24 px-6 lg:px-16 border-y border-site">
        <div className="mx-auto max-w-3xl text-center">
          <SectionBadge>Ma manière de transmettre</SectionBadge>
          <h2 className="mt-8 text-3xl sm:text-4xl text-site font-heading italic mb-8">Un cadre humain et sérieux</h2>
          <div className="space-y-6 text-[var(--site-muted)] font-light leading-relaxed text-sm sm:text-base">
            <p>Je tiens à proposer une formation à taille humaine, dans un cadre bienveillant, sérieux et respectueux. Le petit groupe me permet d’être réellement présente pour chacun, de répondre aux questions et d’ajuster l’accompagnement selon vos sensibilités.</p>
            <p>La communication animale touche à l’intime et au vivant. Pour moi, elle ne peut pas être transmise correctement sans cadre, sans éthique et sans pédagogie. C’est pourquoi cette journée repose autant sur la pratique que sur la qualité de présence, le discernement et le respect de l’animal.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 lg:px-16">
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="bg-[var(--site-surface-solid)] p-8 sm:p-12 rounded-[3rem] border border-site relative flex flex-col justify-between">
              <div>
      ...
      {/* CTA */}
      <section className="py-24 px-6 lg:px-16 text-center bg-[var(--site-bg)]">
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-6 sm:gap-12 group">
      <div className="shrink-0 flex sm:flex-col items-center gap-4">
        <div className="h-14 w-14 rounded-2xl bg-[var(--site-surface)] border border-site flex items-center justify-center text-[#8ba394] group-hover:border-[#8ba394]/50 transition-colors">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-8">
            {details.map((d: string) => (
              <div key={d} className="flex items-center gap-3 text-xs text-[var(--site-muted)] font-light">
                <div className="h-1 w-1 rounded-full bg-[#8ba394]" />
                {d}
              </div>
            ))}
          </div>
