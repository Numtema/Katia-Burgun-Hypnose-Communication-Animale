    ...
    <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      <div className="lg:order-2">
        ...
        <div className="space-y-6 text-[var(--site-muted)] font-light leading-relaxed text-sm sm:text-base">
          ...
          <p>Cet échange permet d’adapter l’accompagnement à votre situation. Le travail se fait ensuite à travers des images et des suggestions adaptées à votre propre solution intérieure.</p>
